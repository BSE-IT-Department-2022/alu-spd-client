        ...
        <AppBar position="static">
            <Container >
                ...
                <Toolbar disableGutters>
                    <img src={logo} alt="Logo" style={{ height: '50px', marginRight: '16px' }} /> {/* Use the imported image */}
...
//   const img = <img src="alu-logo.png" alt='logo' />

        {/* {img} */}
        {/* <img src="alu-logo.png" alt="Logo" style={{ width: '50px', height: '50px', marginRight: '16px' }} />  */}
